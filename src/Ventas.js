...
const Ventas = () => {
    ...
    return (
        <div className="container-fluid position-absolute top-50 start-50 translate-middle m-x-50px" id="cajon1">
            <div class="row">
                <div class="col-4">
                    <div>
                        <h2>
                    ...
                    <div className="col-12 mx-5 mb-5">
                        <button type="button" class="btn btn-secondary rounded-pill mx-5"><i class="fas fa-check"></i></button>
                        <button type="button" class="btn btn-secondary rounded-pill mx-2"><i class="fas fa-times"></i></button>
                        <button type="button" class="btn btn-secondary rounded-pill mx-5"><i class="fas fa-ban"></i></button>
                    </div>
