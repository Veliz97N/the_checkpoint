                    ...
                    <div className="row">
                        ...
                        <div className="col-md-7 col-sm-12">
                            <div className="fuera my-2 mb-4">
                                ...
                                {booleano_feliz_producto == false ? <div style={visible} className="invalido d-flex justify-content-end my-0">Nombre Invalido</div>
                            ...
                            <div className="fuera my-2 mb-4">
                                ...
                                {booleano_feliz_categoria == false ? <div style={visible} className="invalido d-flex justify-content-end my-0">Categoria Invalido</div>
                                    : <div style={no_visible} className="invalido d-flex justify-content-end my-0">Categoria Invalido</div>}
                            </div>
                            ...
                            <div className="fuera my-2 mb-4">
                                ...
                                {booleano_feliz_codigoBarra == false ? <div style={visible} className="invalido d-flex justify-content-end my-0">Codigo de Barras Invalido</div>
                                    : <div style={no_visible} className="invalido d-flex justify-content-end my-0">Codigo de Barras Invalido</div>}
                            </div>
                            ...
                            <div className="fuera my-2 mb-4">
                                ...
                                {booleano_feliz_valor == false ? <div style={visible} className="invalido d-flex justify-content-end my-0">Valor Invalido</div>
                                    : <div style={no_visible} className="invalido d-flex justify-content-end my-0">Valor Invalido</div>}
                            </div>
                            ...
                            <div className="fuera my-2 mb-4">
                                ...
                                {booleano_feliz_stock == false ? <div style={visible} className="invalido d-flex justify-content-end my-0">Stock Invalido</div>
                                    : <div style={no_visible} className="invalido d-flex justify-content-end my-0">Stock Invalido</div>}
                            </div>
                        </div>
